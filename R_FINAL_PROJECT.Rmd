...
#6
The airline with the highest ratio of arrival delays is Frontier Flight (F9). The airline with the lowest arrival delays is American Airlines (AA).
```{r, echo=FALSE}
ggplot(hflights, aes(x = UniqueCarrier, y = ArrDelay)) + geom_boxplot() + ggtitle("Arrival Delays by Airline");
